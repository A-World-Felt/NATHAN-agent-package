...
/**
 * The context strategy port (ADR-AGENT-0016): what actually goes to the model, and the hook that
 * lets a strategy learn from what happened. Every strategy is an implementation of this one
 * interface: the sliding window now, a summarizing or memory-backed strategy later, composed if
 * needed.
 *
