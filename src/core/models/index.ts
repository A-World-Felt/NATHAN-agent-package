// Core kernel: the vocabulary shared by llm and tools (ADR-AGENT-0012).
// Pure types, no runtime, no dependency. Neither llm nor tools imports the other;
 ...
 * this schema is mandatory (spec §10, ADR-AGENT-0006).
 */
